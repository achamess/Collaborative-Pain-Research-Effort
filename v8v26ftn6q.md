Purpose and Vision:
This review article will broadly summarize some of the powerful emerging technologies in neuroscience with a focus on their application to the study of pain. Whenever possible, examples in which these technologies have already been applied to pain will be given (ex. Optogenetics, Calcium Imaging). In the second part of the review, we will outline fundamental and large-scale questions that may now be profitably studied using these emerging technologies. 
...
- Stem cell manipulation of pain systems 
...
### Question : What is the natural variation of pain-related genomic features in the human population and how do these variations contribute to phenotypic variability?
...
- Discuss how these big questions require concerted efforts and coordination among many groups. Better to work as distributed and allied teams 
